...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'defcoin-build', autostart: false do |gitian|
...
#    gitian.vm.synced_folder "./defcoin-binaries", "/home/vagrant/defcoin-binaries", create: true
    gitian.vm.post_up_message = "Defcoin deterministic build environment started."
  end
